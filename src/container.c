...
static SDLGuiTK_Container * Container_create()
{
  ...
  new_container->children_area.x = 0;  new_container->children_area.y = 0;
  new_container->children_area.w = 0;  new_container->children_area.h = 0;
...
void PROT__container_DrawUpdate( SDLGuiTK_Container * container )
{
  ...
  container->widget->rel_area.w = \
    container->children_area.w + 2*(container->border_width);
  container->widget->rel_area.h = \
