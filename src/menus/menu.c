...
/*     printf( "ERROR\n" ); */
  ...
  widget->container->children_area.w = current->rel_area.w +6;
  widget->container->children_area.h = current->rel_area.h +6;
...
/*     printf( "ERROR\n" ); */
  ...
  current_child->parent_area.y = widget->container->border_width + 3;
